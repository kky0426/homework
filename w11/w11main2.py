def speech():       
	...
	Bush = ["Vice President Cheney Mr Chief Justice President Carter President Bush President Clinton reverend clergy distinguished guests fellow citizens",
        	...
        	"Our goal instead is to help others find their own voice attain their own freedom and make their own freedom and",
        	...
        	"My most solemn duty is to protect this nation and its people against further attacks and emerging threats and make their own way",
        	...
        	"When our Founders declared a new order of the ages; when soldiers died in wave upon wave for union based on liberty; when citizens marched in peaceful outrage under the banner Freedom Now they were acting on an ancient hope that is meant to be fulfilled",
	...
	Lincoln=list()
	Lincoln=["AT this second appearing to take the oath of the Presidential office there is less occasion for an extended address than there was at the first. "
	...
	print  "Bush speech Frequent words:"
	for i in d1:
    		if d1[i]>20:       
        		print  i,d1[i],        
	...
	print "Licoln speech Frequent words:"
	for i in d2:
    		if d2[i]>20:
        		print i,d2[i],
...
def survey():
	...
	survey=list()
	survey=[["Division","Very Good","Good","Bad","Very bad"],["Class quality",13.1,37.1,8.7,1.5
	...
	print "good average:",sum/len(s)
        print "bad average:", sum2/len(s)
